...
types displayed a clear pattern of change \citep[p.~220]{PFG1951}:
...
multiple dimensions \citep{PFG1951, Lipo2001}. The overall process
...
Processes}\label{multser:sec:unimodality-and-cultural-transmission-processes}
...
\caption{Seriation solution with frequency and continuity seriation for PFG \citeyearpar{PFG1951} ceramic assemblages in 
the Lower Mississippi River Valley, as analyzed by Lipo \citeyearpar{Lipo2001a} and re-analyzed by \citet{Lipo2015}.  There are no differences between frequency and continuity ordering algorithms in analyzing this set of assemblages, and thus only one graph is shown.}
\label{multser:img:pfg-both-solutions}
\end{figure}
...
\label{multser:tab:f8a6f378-freq-table}
\end{sidewaystable}

\textcolor{teal}{Viewed in traditional tabular view of the type counts in Tables
